...
/// @brief Enumeration des identifiants des joueurs.
...
/// @brief Enumeration des états possibles d'une case du plateau.
...
/// @brief Enumeration des états possibles de la partie.
typedef enum GameState_e
{
    ...
    GAME_P2_WON = 2,
    /// @brief Indique que la partie s'est terminée sur une égalité.
    GAME_IS_TIED
} GameState;
...
/// L'utilisateur doit le vérifier avec Game_CanPlayAt() avant d'appeler cette m�thode.
/// @param self la partie.
/// @param column l'indice de la colonne.
...
/// @param self la partie.
/// @param P1 le joueur numéro 1
/// @param P2 le joueur numéro 2
/// @param Take le nombre de pion dans la ligne
